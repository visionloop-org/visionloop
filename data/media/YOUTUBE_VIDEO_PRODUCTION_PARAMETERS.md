...
```mermaid
graph TD
    classDef hook fill:#ef4444,stroke:#dc2626,stroke-width:2px,color:#fff;
    classDef problem fill:#f59e0b,stroke:#d97706,stroke-width:2px,color:#fff;
    classDef solution fill:#06b6d4,stroke:#0891b2,stroke-width:2px,color:#fff;
    classDef cta fill:#10b981,stroke:#059669,stroke-width:2px,color:#fff;

    S1["⚡ SCENE 1: HOOK (0s - 3s)<br/>'How EV Fleets Scale with ZERO Debt!'<br/>• Fast zoom into Tata Intra EV digital cluster"]:::hook
    S2["⚠️ SCENE 2: THE PROBLEM (3s - 15s)<br/>'Battery depreciation ruins fleet margins.'<br/>• High loan interest breakdown"]:::problem
    S3["💰 SCENE 3: VISION LOOP SOLUTION (15s - 35s)<br/>'The 15% Sinking Fund + AI CAN-Bus Shield'<br/>• Live telemetry graph at 99.4% SoH"]:::solution
    S4["🚀 SCENE 4: CALL TO ACTION (35s - 45s)<br/>'Lease Clean. Visit visionloop.in'<br/>• Kinetic Subscribe burn & Pinned comment link"]:::cta
