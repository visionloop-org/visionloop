...
```mermaid
graph TD
    classDef it fill:#06b6d4,stroke:#0891b2,stroke-width:2px,color:#fff;
    classDef asci fill:#f59e0b,stroke:#d97706,stroke-width:2px,color:#fff;
    classDef dpdp fill:#8b5cf6,stroke:#7c3aed,stroke-width:2px,color:#fff;
    classDef tax fill:#10b981,stroke:#059669,stroke-width:2px,color:#fff;

    R1["⚖️ IT RULES 2021 (Digital Media Ethics)<br/>• Universal 'U' Rating<br/>• Grievance Redressal Officer in India<br/>• 24-Hr Acknowledgment / 15-Day Resolution"]:::it
    R2["📢 ASCI & CONSUMER PROTECTION ACT 2019<br/>• Mandatory Paid Sponsorship Disclosures<br/>• YouTube 'Includes Paid Promotion' Box Checked<br/>• SEBI Educational Financial Disclaimers"]:::asci
    R3["🔒 DPDP ACT 2023 (PII Redaction)<br/>• 25px Gaussian Blur over PAN & Aadhaar<br/>• Vehicle Full Chassis VIN Masking<br/>• Driver Personal Phone Redaction"]:::dpdp
    R4["💰 GST COUNCIL & FEMA (Forex AdSense)<br/>• SAC 998361 Zero-Rated Export with LUT<br/>• Bank Foreign Inward Remittance (FIRC)<br/>• Form W-8BEN Indo-US DTAA 15% Rate"]:::tax
```
