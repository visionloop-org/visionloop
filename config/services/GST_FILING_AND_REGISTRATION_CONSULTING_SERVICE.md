...
```mermaid
graph TD
    classDef srv fill:#06b6d4,stroke:#0891b2,stroke-width:2px,color:#fff;
    classDef flow fill:#8b5cf6,stroke:#7c3aed,stroke-width:2px,color:#fff;
    classDef itc fill:#10b981,stroke:#059669,stroke-width:2px,color:#fff;
    classDef cl fill:#f59e0b,stroke:#d97706,stroke-width:2px,color:#fff;

    S1["💼 GST SERVICE OFFERING<br/>• Sole Proprietorship Form GST REG-01 Registration<br/>• Monthly GSTR-1 & GSTR-3B Automated Filing<br/>• Zero-Rated Export LUT for YouTube & SaaS"]:::srv

    F1["📋 5-STEP ONBOARDING WORKFLOW<br/>1. Client KYC & PAN Validation<br/>2. Spousal / Shared Premises NOC Generation<br/>3. Part A TRN Generation on gst.gov.in<br/>4. Part B Dossier Upload & Aadhaar e-KYC<br/>5. ARN Generation & Certificate (Form GST REG-06)"]:::flow

    I1["💰 TAX OPTIMIZATIONS<br/>• 100% Commercial EV Section 17(5)(a) ITC Claim<br/>• AdSense FIRC Cross-Border Zero Tax LUT<br/>• MSMED Act 45-Day Overdue Invoice Protection"]:::itc

    CL["👥 TARGET CLIENTS<br/>• Commercial EV & Truck Operators<br/>• YouTube Creators & Digital Influencers<br/>• Freelance Software Developers & SaaS Founders"]:::cl
